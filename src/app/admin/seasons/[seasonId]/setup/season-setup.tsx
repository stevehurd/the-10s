    ...
    <>
      ...
      <section className="rounded-2xl border border-white/10 bg-slate-900 p-5">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-[1fr_160px_auto] sm:items-end">
          ...
          <button className="rounded-lg bg-blue-600 px-4 py-2.5 font-semibold text-white disabled:opacity-50" disabled={draftConfigured || busy !== null || !newUserId} onClick={addSeat}>Add seat</button>
        </div>
      ...
      <section className="flex flex-wrap gap-3">
        {demo ? (
          ...
          <>
            <Link className="rounded-xl border border-white/10 bg-white/5 px-4 py-2 font-semibold" href={`/admin/seasons/${seasonId}/eligibility`}>Manage college team pool</Link>
